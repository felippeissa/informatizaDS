...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, ButtonModule, InputTextModule, TableModule, DialogModule, TooltipModule, ToggleSwitchModule, TagModule],
    styles: [`
