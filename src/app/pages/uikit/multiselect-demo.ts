...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, MultiSelectModule, TabsModule, TableModule],
    styles: [DEMO_STYLES + `
    ...
    template: `
        <div class="comp-header">
            <h1 class="comp-name">MultiSelect</h1>
            <p class="comp-desc">Dropdown de seleção múltipla com chips e filtro para escolher vários itens.</p>
            <div class="import-snippet">
                <span class="tok-kw">import</span><span class="tok-pt">&nbsp;&#123;&nbsp;</span><span class="tok-id">MultiSelectModule</span><span class="tok-pt">&nbsp;&#125;&nbsp;</span><span class="tok-kw">from</span><span class="tok-str">&nbsp;'primeng/multiselect'</span><span class="tok-pt">;</span>
            </div>
        </div>
                    ...
                    <div class="demo-card">
                        ...
                        <div class="demo-card-body col" style="gap:16px;padding:20px">
                            ...
                            <div class="form-col">
                                ...
                                <p-multiselect [(ngModel)]="multiVal2" [options]="cities" optionLabel="name" placeholder="Busque e selecione" [fluid]="true" [filter]="true" />
                            </div>
                        </div>
...
export class MultiSelectDemo {
    ...
    code = `<p-multiselect [(ngModel)]="cidades"
    [options]="opcoes"
    optionLabel="name"
    ...
    props = [
        ...
        { name: 'display',       type: 'string',  default: 'comma', description: 'Exibição: "comma" ou "chip".' },
        { name: 'filter',        type: 'boolean', default: 'false', description: 'Habilita campo de busca.' },
        { name: 'maxSelectedLabels', type: 'number', default: '3',  description: 'Máximo de labels antes de mostrar "X selecionados".' },
    ...
    themeVars = [
        { variable: '--p-multiselect-background',                description: 'Fundo do multiselect.' },
        { variable: '--p-multiselect-border-color',              description: 'Borda.' },
        { variable: '--p-multiselect-border-radius',             description: 'Raio de borda.' },
        { variable: '--p-multiselect-option-focus-background',   description: 'Fundo da opção em hover.' },
        { variable: '--p-multiselect-option-selected-background',description: 'Fundo da opção selecionada.' },
    ];
}
