...
@Component({
    ...
    template: `
        <div class="comp-header">
            ...
            <p class="comp-desc">Gráficos baseados em Chart.js integrados ao PrimeNG. Suporte a linha, barra, pizza, rosca e mais.</p>
